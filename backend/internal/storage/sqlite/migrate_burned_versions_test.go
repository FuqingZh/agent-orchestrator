...
var shippedMigrations = map[int64]string{
	...
	37: "0037_workflow_issue_runs.sql",
	38: "0038_drop_worker_idle_outbox.sql",
	39: "0039_drop_workflow_issue_runs.sql",
	40: "0040_orchestrator_reengagement.sql",
	41: "0041_repair_orchestrator_reengagement.sql",
	42: "0042_drop_orchestrator_reengagement.sql",
	43: "0043_add_session_diff_base.sql",
	44: "0044_notification_resolution.sql",
	45: "0045_review_run_unique_per_harness.sql",
	46: "0046_add_session_pinned.sql",
...
// 0043_add_session_diff_base.sql and the sessions table lacks the diff-base
...
func TestSessionListSucceedsOnBurnedMigrationHistory(t *testing.T) {
	...
	upTo(t, db, 39) // the real 0043 has not run; diff-base columns are absent
	for v := 40; v <= 51; v++ {
		if _, err := db.Exec(
