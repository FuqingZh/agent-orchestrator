...
| [plans/2026-08-06-v0.12.1-baseline-sync.md](plans/2026-08-06-v0.12.1-baseline-sync.md) | Planned source-only synchronization from fork `main` to upstream v0.12.1, including migration-lineage reconciliation and separate Codex black-box validation. |
| [plans/2026-08-10-v0.12.2-baseline-sync.md](plans/2026-08-10-v0.12.2-baseline-sync.md) | Planned stable synchronization from fork `main` to upstream v0.12.2, including migration-lineage convergence, downstream-delta audit, isolated release canaries, optional later main snapshot, and separately authorized production cutover. |
